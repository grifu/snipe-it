...
class RequestAssetApprovalNotification extends Notification
{
    /**
     * @var
     */
    ...
    public function toSlack()
    {
        ...
        $fields = [
            'QTY' => $qty,
            'Approved By' => '<'.$target->present()->viewUrl().'|'.$target->present()->fullName().'>',
        ];
        ...
        return (new SlackMessage)
            ->content( trans('mail.a_user_approved'))
            ->from($botname)
    ...
    public function toMail($notifiable)
    {
        ...
        $message = (new MailMessage)->markdown('notifications.markdown.asset-requested',
            [
                ...
                'intro_text'        => trans('mail.a_user_approved'),
            ])
            ->subject(trans('Item Request Approved'));
